...
# We are interested in maximizing the accuracy of predicting systemic crises.
...
sensitivity_fit <- optim(.60, calc_sensitivity, method = "Brent", lower = 0, upper = 1)

cutoff <- sensitivity_fit$par
...
### Compare results of simple logistic regression to multiple logistic regression

Systemic Crisis regressed on banking crisis alone
[1] "Training Accuracy 0.977337110481586"
[1] "Sensitivity 0.926829268292683"
[1] "Sensitivity 0.98157625383828"
[1] "Correctly predicted 76 of 82 crises"
[1] "False positives 18"
[1] "Cutoff value 0.407364127782024"

Systemic Crisis regressed on all predictors
[1] "Training Accuracy 0.975448536355052"
[1] "Sensitivity 0.817073170731707"
[1] "Sensitivity 0.988741044012282"
[1] "Correctly predicted 67 of 82 crises"
[1] "False positives 11"
[1] "Cutoff value 0.73940337828769"

```{r}
sort(exp(mlr_fit$coefficients) - 1, decreasing = TRUE)
```


### Multiple Logistic Regression of Banking Crisis on Annual Inflation Indices
